...
if (racketSection) {
  ...
  const updateRacketProgress = () => {
    ...
    const progress = getSectionProgress(racketSection);
  ...
  window.addEventListener("scroll", updateRacketProgress, { passive: true });
  window.addEventListener("resize", updateRacketProgress);
}
...
if (featureSections.length) {
  ...
  window.addEventListener("scroll", updateFeatureSections, { passive: true });
  window.addEventListener("resize", updateFeatureSections);
}
